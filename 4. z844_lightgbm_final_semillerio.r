...
kdataset       <- "./exp/FE8150/dataset_8150IPC2.csv.gz"
ksemilla_azar  <- 160807  #Aqui poner la propia semilla
ktraining      <- c( 202011,202012,202101 )   #periodos en donde entreno
kfuture        <- c( 202103 )   #periodo donde aplico el modelo final


kexperimento   <- "KA8440_m3ipc2_2ranking"

ksemilla_primos  <-  102191
ksemillerio  <- 50

kmax_bin           <-   31
klearning_rate     <-   0.0100406983981141
knum_iterations    <-   5041
knum_leaves        <-   121
kmin_data_in_leaf  <-   5756
kfeature_fraction  <-   0.547824097664421
